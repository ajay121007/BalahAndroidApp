...
public class CircularSeekBar extends View {
	...
	protected static final float DEFAULT_POINTER_RADIUS = 3f;
	protected static final float DEFAULT_POINTER_HALO_WIDTH = 8f;
	protected static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 8f;
	...
	protected static final int DEFAULT_MAX = 1000;
	protected static final int DEFAULT_PROGRESS = 1;
	protected static final int DEFAULT_CIRCLE_COLOR = Color.GRAY;
	protected static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(225,216,200,0);
	 ...
	 */
	public float calculateProgressDegrees() {
	 ...
	 */
	protected float calculatePointerAngle() {
