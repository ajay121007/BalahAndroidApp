package bidding.app.view.fragment.purchasefragment;
...
public class PurchaseFragment extends BaseFragment implements PurchaseFragmentView, GoogleApiClient.ConnectionCallbacks,
    ...
    PurchaseFragmentPresenterHandler handler;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        auctionOwnerId = b.getString("auctionOwnerId");
        auctionId = b.getString("auctionId");
        mStatus = b.getString("status");
        mPaymentStatus = b.getString("payment_status");
    ...
    private void init(View view) {
        ...
        tvManageQuntity = view.findViewById(R.id.tv_manage_Quntity);
        ...
        handler = new PurchaseFragmentPresenter(this, tvPayment,tvPay);
    }
    ...
    private void auctionOwnerInfo(String ownerid, String auction_id) {
        showProgressDialog();
        ModelManager.getInstance().getAuctionOwnerInfo().AuctionOwnerInfo(getActivity(),
                Operations.getAuctionOwnerInfo(getActivity(), "auctionOwner_detail", ownerid, auction_id));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_ok:
                ...
                handler.moveToInventory(getActivity(), "moveToInventory", CSPreferences.readString(getActivity(), Constants.USERID), auctionId, mInventory, mDelivery);
                break;
    ...
    public void showConfirmAlert(String title, String message) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                handler.pendingPayment(getActivity(), "pendingPaymentComplete", mUserId, mProductId, "2",auctionId,mCardNumber);
                alertDialog.dismiss();
            }
        });
