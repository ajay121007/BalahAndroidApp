...
public class PurchaseFragmentPresenter implements PurchaseFragmentPresenterHandler {

    PurchaseFragmentView view;
    TextView tvpayment,tvPay;
    String mStatus = "";

    public PurchaseFragmentPresenter(PurchaseFragment history_fragment, TextView tvPayment, TextView tvPay) {
